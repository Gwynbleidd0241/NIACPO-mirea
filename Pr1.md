...
Описание команд:<br>
ZADD - Добавление элементы в упорядоченное множество с указанным весом<br>
ZDIFF - Возвращение элементов, которые есть в первом множестве, но нет во втором<br>
ZCOUNT - Возвращение количество элементов с весами в указанном диапозоне<br>
ZPOPMAX - Извлечение элемента с наибольшим весом<br>
ZPOPMIN - Извлечение элемента с наименьшим весом<br>
ZUNION - Возвращение объединения нескольких упорядоченных множеств<br>
...
![image](https://github.com/user-attachments/assets/c37de95b-926e-48e0-a34c-17da413b3851)
